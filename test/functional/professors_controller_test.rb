...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { course: @professor.course, currentScore: @professor.currentScore, emailAddress: @professor.emailAddress, loginPassword: @professor.loginPassword }
    end
  ...
  test "should update professor" do
    put :update, id: @professor, professor: { course: @professor.course, currentScore: @professor.currentScore, emailAddress: @professor.emailAddress, loginPassword: @professor.loginPassword }
    assert_redirected_to professor_path(assigns(:professor))
  end
