...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { courseName: @score.courseName, gameMode: @score.gameMode, score: @score.score }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { courseName: @score.courseName, gameMode: @score.gameMode, score: @score.score }
    assert_redirected_to score_path(assigns(:score))
  end
